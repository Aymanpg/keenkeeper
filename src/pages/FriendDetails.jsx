        ...
        <div className="lg:col-span-5 bg-white rounded-3xl p-8 border border-gray-100">
          <div className="flex flex-col items-center text-center">
            <img
              src={friend.picture}
              alt={friend.name}
              className="w-28 h-28 rounded-3xl object-cover mb-6"
            />
            <h2 className="text-3xl font-semibold text-text-dark">{friend.name}</h2>
            ...
            <p className="mt-8 text-text-body leading-relaxed">{friend.bio}</p>
          ...
          <div className="mt-12 space-y-3">
            <button className="w-full flex items-center justify-center gap-3 bg-white border border-gray-200 hover:border-accent py-4 rounded-2xl font-medium">
              ⏰ Snooze 2 Weeks
            </button>
            <button className="w-full flex items-center justify-center gap-3 bg-white border border-gray-200 hover:border-accent py-4 rounded-2xl font-medium">
              📦 Archive
            ...
            <button
              onClick={() => navigate('/')}
              className="w-full flex items-center justify-center gap-3 text-overdue hover:bg-red-50 py-4 rounded-2xl font-medium"
            >
              🗑️ Delete
            </button>
          </div>
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="bg-white rounded-3xl p-6 text-center">
              <div className="text-4xl font-bold text-text-dark">{friend.days_since_contact}</div>
              <div className="text-text-body text-sm mt-1">Days Since Contact</div>
            </div>
            <div className="bg-white rounded-3xl p-6 text-center">
              <div className="text-4xl font-bold text-text-dark">{friend.goal}</div>
              <div className="text-text-body text-sm mt-1">Goal (Days)</div>
            </div>
            <div className="bg-white rounded-3xl p-6 text-center">
              <div className="text-4xl font-bold text-text-dark">{friend.next_due_date}</div>
