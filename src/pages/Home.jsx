...
export default function Home() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 xl:px-44 py-6 sm:py-8">
      {/* Banner */}
      <div className="bg-white rounded-3xl shadow-sm p-6 sm:p-8 lg:p-10 text-center mb-8 sm:mb-12">
        <h1 className="text-4xl sm:text-5xl font-bold text-text-dark mb-4">
          Friends to keep close in your life
        </h1>
        <p className="text-text-body max-w-2xl mx-auto text-base sm:text-lg mb-8">
          Your personal shelf of meaningful connections. Browse, tend, and nurture the relationships that matter most.
        </p>
        <Link
          to="/timeline"
          className="inline-flex items-center gap-3 bg-primary hover:bg-accent text-white px-6 sm:px-8 py-3.5 sm:py-4 rounded-2xl text-base sm:text-lg font-semibold transition-all"
        >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 mt-10 sm:mt-12">
          <div className="bg-white border border-gray-100 rounded-2xl p-5 sm:p-6 text-center shadow-sm">
            <div className="text-3xl sm:text-4xl font-bold text-primary">{totalFriends}</div>
            <div className="text-text-body text-sm mt-1">Total Friends</div>
          </div>
          <div className="bg-white border border-gray-100 rounded-2xl p-5 sm:p-6 text-center shadow-sm">
            <div className="text-3xl sm:text-4xl font-bold text-primary">{onTrack}</div>
            <div className="text-text-body text-sm mt-1">On Track</div>
          </div>
          <div className="bg-white border border-gray-100 rounded-2xl p-5 sm:p-6 text-center shadow-sm">
            <div className="text-3xl sm:text-4xl font-bold text-primary">{needAttention}</div>
            <div className="text-text-body text-sm mt-1">Need Attention</div>
          </div>
          <div className="bg-white border border-gray-100 rounded-2xl p-5 sm:p-6 text-center shadow-sm">
            <div className="text-3xl sm:text-4xl font-bold text-primary">{interactionsThisMonth}</div>
      ...
      <div className="mb-4 sm:mb-6">
        <h2 className="text-2xl sm:text-3xl font-semibold text-text-dark mb-4 sm:mb-6">
          Your Friends
        </h2>
      </div>
